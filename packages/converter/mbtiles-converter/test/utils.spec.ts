import {convertNumberToBufferLE} from "../src/utils";


describe("convertNumberToBufferLE", ()=> {
    it("should convert 4 bytes", ()=>{
        // 11100 11100101 11011010
        // 28    229      218
        const num = 1893850;

        const actualBuffer = convertNumberToBufferLE(num, 4);
    ...
    it("should convert 5 bytes", ()=>{
        ...
        const actualBuffer = convertNumberToBufferLE(num);
